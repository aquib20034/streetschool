...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    getUploadImage: function getUploadImage() {
      var image = this.form.image.length > 200 ? this.form.image : "img/project/" + this.form.image;
      return image;
    },
    getImage: function getImage() {
      var prefix = this.form.image.match(/\//) ? '' : '/img/project/';
    ...
    showModal: function showModal(project) {
      this.form.reset();
      this.loadDesignation();
    ...
    deleteproject: function deleteproject(id, name) {
      var _this6 = this;
                    ...
                    _c(
                      ...
                      _vm._l(_vm.projects.data, function(project) {
                        return _c("tr", { key: project.id }, [
                          ...
                          _vm._v(" "),
                          _c("td", [
                            _vm._v(_vm._s(_vm._f("myDate")(project.created_at)))
                          ]),
                          _vm._v(" "),
                          _c("td", [
                            _c(
              ...
              _c(
                ...
                [
                  _c(
                    ...
                    [
                      _c("strong", [
                        _vm._v("Project Name: " + _vm._s(_vm.form.name))
                      ]),
                      _vm._v(" "),
                      _c("hr"),
                      _vm._v(" "),
