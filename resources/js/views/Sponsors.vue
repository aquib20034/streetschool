 ...
 <div class="content">
            ...
            <div class="col-md-12">
                <div class="card">
                            ...
                            <table id="multi-filter-select" class="display table table-striped table-hover" >
                                ...
                                <tbody>
                                    ...
                                    <tr v-for="sponsor  in sponsors.data" :key="sponsor.id"> 
                                        <td>{{sponsor.name|upText}}</td>
                                        <td>{{sponsor.description}}</td>
                                        <td>{{sponsor.created_at|myDate}}</td>
                                        <td>
                                            ...
                                            <div class="list-group-item-figure">
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <a class="dropdown-item" @click="editModal(sponsor)">
                                                            <i class="fa fa-edit"></i> Edit
                                                        </a>

                                                        <a class="dropdown-item" @click="showModal(sponsor)">
                                                            <i class="fa fa-eye"></i> show
                                                        </a>
                                                        <a class="dropdown-item"  @click ="deletesponsor(sponsor.id,sponsor.name)">
                    ...
                    <div class="card-footer">
                        <pagination :data="sponsors" @pagination-change-page="getResults"></pagination>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" v-show="!editMode" id="addDataModalLabel">Add sponsor</h5>
                      <h5 class="modal-title" v-show="editMode" id="addDataModalLabel">Update sponsor</h5>
                ...
                <form @submit.prevent="editMode ? updateData() :createData()" >
                    <div class="modal-body">
                        <div class="form-group">
                            <input v-model="form.name" placeholder="Enter sponsor Name" id ="name" type="text" name="name"
    ...
    <div class="modal fade" id="showDataModal" tabindex="-1" role="dialog" aria-labelledby="showDataModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                      <h5 class="modal-title" id="showDataModalLabel">Show sponsor</h5>
                    <button class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form @submit.prevent="" >
                    <div class="modal-body">
                        <strong>Sponsor Name: {{form.name}}</strong>
                        <hr>
...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            getUploadImage() {
                let image = (this.form.image.length>200)? this.form.image:"img/sponsor/"+this.form.image ;
                return image;
                
            },
            getImage() {
                let prefix = (this.form.image.match(/\//) ? '' : '/img/sponsor/');
            ...
            loadsponsors(){
                axios.get("api/sponsor").then(({data})=>(this.sponsors=data));
